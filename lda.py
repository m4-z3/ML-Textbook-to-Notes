...
class TopicModeling:    
    ...
    def groupSentence(self, paragraph, alpha='asymmetric', eta=0.000001):
        ...
        self.lda_model = LdaModel(corpus=self.corpus, id2word=self.dictionary, num_topics=self._topicNum, random_state=100, chunksize=10, update_every=0, passes=60, alpha=alpha, eta=eta)
